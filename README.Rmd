...
You can install the development version of testingdsem from [GitHub](https://github.com/) with:
...
* Each figure shows the fitted network as found in the dsem [vignette](https://james-thorson-noaa.github.io/dsem/articles/vignette.html#comparison-with-dynamic-linear-models) alongside the same fitted network but with 25% of each of the variables data set as missing(NA). The NAs were randomly omitted
